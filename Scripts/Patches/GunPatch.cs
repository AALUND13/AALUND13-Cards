...
namespace AALUND13Cards.Patches {
    ...
    public class GunPatch {
        ...
        public static void Prefix(Gun __instance, GameObject obj) {
            RailgunStats railgunStats = __instance.player.data.GetAdditionalData().CustomStatsRegistry.GetOrCreate<RailgunStats>();
        ...
        public static void InjectUseCharge(Gun gun) {
            var stats = gun.player.data.GetAdditionalData().CustomStatsRegistry.GetOrCreate<RailgunStats>();
