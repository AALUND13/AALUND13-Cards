...
namespace AALUND13Card {
    public static class LoggerUtils {
        ...
        public static void LogWarn(string message) { if(logging) AALUND13_Cards.ModLogger.LogWarning(message); }
        public static void LogError(string message) { if(logging) AALUND13_Cards.ModLogger.LogError(message); }
    }
}
